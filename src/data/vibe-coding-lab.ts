...
export const vibeCodingLab = {
  ...
  slides: {
    ...
    framework: {
      ...
      loopNote: "Then you do it again. Test, adjust, test. That loop is how everything gets built.",
    ...
    reflection: {
      ...
      parsons: {
        ...
        steps: [
          ...
          { id: "remix", label: "Adjust it", body: "Ask for one change, then test again." },
        ],
        check: "Check order",
        success: "That is the loop. Say it, test it, adjust it, then go again.",
  ...
  aiPanel: {
    ...
    quickLead: "Or send a quick prompt",
    send: "Send",
    copy: "Copy",
    copied: "Copied",
