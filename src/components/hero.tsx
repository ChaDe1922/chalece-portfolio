...
export function Hero() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(48%_55%_at_92%_-8%,color-mix(in_oklch,var(--primary)_20%,transparent),transparent_70%),radial-gradient(42%_48%_at_100%_55%,color-mix(in_oklch,var(--coral)_14%,transparent),transparent_72%)]"
      />
      ...
      />
      <div className="relative mx-auto max-w-5xl px-4 pb-20 pt-20 md:px-8 md:pb-28 md:pt-28">
        ...
        <h1
          id="hero-heading"
          className="enter enter-2 max-w-4xl text-balance text-[2.5rem] font-bold leading-[1.06] tracking-tight sm:text-6xl sm:leading-[1.04] md:text-7xl"
        >
        ...
        <div className="enter enter-4 mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
