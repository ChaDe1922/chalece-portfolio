 ...
 *  Early so the discrete elements dissolve in place before the merged path
 *  forms, leaving no lingering ghosts. */
export const mergeFactor = (scroll: number) => smooth(0.22, 0.5, scroll);
