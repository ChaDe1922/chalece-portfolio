...
const data = fourierLab.slides.outroTwo;

/** Closing slide for Lesson 2: recap what you can do now, then a clickable teaser
 *  card that carries you into Part 3. Mirrors OutroOne. */
export function OutroTwo() {
  return (
